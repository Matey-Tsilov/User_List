const UserRow = ({user, detailsClick, deleteClick, updateClick}) => {
    ...
    <tr>
        ...
        <td className="actions">
          <button className="btn edit-btn" title="Edit" onClick={() => updateClick(user._id)}>
          ...
          <button className="btn delete-btn" title="Delete" onClick={() => deleteClick(user._id)}>
          ...
          <button onClick={() => detailsClick(user._id)} className="btn info-btn" title="Info">
